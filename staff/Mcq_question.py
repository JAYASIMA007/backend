    ...
    if request.method == "POST":
        try:
            ...
            for question_data in questions:
                ...
                blooms = str(question_data.get("blooms", "")).strip()  # Add blooms field
                ...
                # Skip rows with missing critical information
                if not all([question, options, correctAnswer, blooms]):
                ...
                valid_question = {
                    ...
                    "tags": question_tags,
                    "blooms": blooms  # Include blooms field
                }
    ...
    if request.method == "POST":
        try:
            ...
            for question_data in questions:
                ...
                blooms = str(question_data.get("blooms", "")).strip()
                ...
                valid_question = {
                    ...
                    "level": level,
                    "tags": tags,
                    "blooms": blooms  # Add the blooms field here
                }
                valid_questions.append(valid_question)
...
def append_question_to_test(request):
    if request.method == "POST":
        try:
            ...
            level = str(data.get("level", "")).strip().lower()
            tags = data.get("tags", [])
            blooms = str(data.get("blooms", "")).strip()  # Extract blooms field
            ...
            new_question = {
                ...
                "blooms": blooms  # Include the blooms field
            }
